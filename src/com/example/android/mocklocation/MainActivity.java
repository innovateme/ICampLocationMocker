        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (code1) {
                ...
                case LocationUtils.CODE_CONNECTION_FAILED:                	
                    mActivityIndicator.setVisibility(View.GONE);
                    if (code2 == ConnectionResult.DATE_INVALID) {
                        mConnectionStatus.setText(
                                context.getString(R.string.connection_failure, "Date Invalid"));
                    	
                    }
                    else if (code2 == ConnectionResult.DEVELOPER_ERROR) {
                        mConnectionStatus.setText(
                                context.getString(R.string.connection_failure, "Developer Error"));
                    }
                    else if (code2 == ConnectionResult.NETWORK_ERROR) {
                        mConnectionStatus.setText(
                                context.getString(R.string.connection_failure, "Network Error"));
                    }
                    else {
                    	mConnectionStatus.setText(
